"""
Задача: Создать класс `Task`¹, который позволяет управлять задачами (делами). У задачи должны быть атрибуты:
описание задачи², срок выполнения³ и статус (выполнено/не выполнено)⁴. Реализовать функцию для добавления задач⁵,
